...
Meteor.methods({
    ...
    getChampionMasteryByPlayerIdAndChampionId: function (v) {
        this.unblock();
        return requestHelper.call('GET', requestHelper.buildFullUrl(`/championmastery/location/${requestHelper.region}/player/${v.playerId}/champion/${v.championId}`));
    },
    ...
    getAllChampionMasteriesByPlayerId: function (v) {
        this.unblock();
        return requestHelper.call('GET', requestHelper.buildFullUrl(`/championmastery/location/${requestHelper.region}/player/${v.playerId}/champions`));
    },
    ...
    getTotalChampionMasteryScoreByPlayerId: function (v) {
        this.unblock();
        return requestHelper.call('GET', requestHelper.buildFullUrl(`/championmastery/location/${requestHelper.region}/player/${v.playerId}/score`));
    },
    ...
    getSpecifiedChampionMasterEntriesByPlayerId: function (v) {
        this.unblock();
        return requestHelper.call('GET', requestHelper.buildFullUrl(`/championmastery/location/${requestHelper.region}/player/${v.playerId}/topchampions${v.count ? `?count=${v.count}` : ''}`));
    }
});

...
Meteor.methods({
    ...
    createTournamentCode: function (v) {
        this.unblock();
        return requestHelper.call('POST', requestHelper.buildFullUrl(`/tournament/public/${apiVersion}/code`, v.message));
    },
    ...
    getTournamentByCode: function (v) {
        this.unblock();
        return requestHelper.call('GET', requestHelper.buildFullUrl(`/tournament/public/${apiVersion}/code/${v.tournamentCode}`));
    },
    ...
    updateTournamentByCode: function (v) {
        this.unblock();
        return requestHelper.call('PUT', requestHelper.buildFullUrl(`/tournament/public/${apiVersion}/code/${v.tournamentCode}`, v.message));
    },
    ...
    getTournamentLobbyEventsByCode: function (v) {
        this.unblock();
        return requestHelper.call('GET', requestHelper.buildFullUrl(`/tournament/public/${apiVersion}/lobby/events/by-code/${v.tournamentCode}`));
    },
    ...
    createTournamentProvider: function (v) {
        this.unblock();
        return requestHelper.call('POST', requestHelper.buildFullUrl(`/tournament/public/${apiVersion}/provider`));
    },
